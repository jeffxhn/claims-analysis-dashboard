...
| :--- | :--- |
| Variables & Data Types | `Dim`, `Long`, `Double`, `String`, `Boolean` |
| Loops | `For Loop`, `For Each`, `Do Loop` |
...
| Age vs Claim Amount | Scatter Plot | No strong correlation between age and claim amount |
...
- **Excel/VBA**: PivotTables, VLOOKUP/XLOOKUP, Solver (optimization, efficient frontier, Sharpe ratio), Monte Carlo simulation, financial modeling, cash flow forecasting, risk measurement, scenario analysis, data-driven decision making
- **VBA (Self-directed)**: Macro recording & modification, loops/conditions, cross-file automation, FileDialog, error handling, user-defined functions (UDFs), report formatting automation
- **Tableau**: Data preprocessing, data integration (joins/union/relationships), bar/line/scatter/treemap/histogram/heatmap/pie charts, interactive dashboards with filters/actions/tooltips, KPI reporting
